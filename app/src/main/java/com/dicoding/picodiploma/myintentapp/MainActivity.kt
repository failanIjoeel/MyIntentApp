    ...
    override fun onClick(v: View) {
       when (v.id){
           ...
           R.id.btn_move_activity_data -> {
            ...
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Wendy Noer Isnaeni")
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17)
            startActivity(moveWithDataIntent)
           }
           R.id.btn_move_with_object -> {
               val person = Person(
                   "Failan Rahsya Izzul Pratama",
                   16,
                   "failanrahsya91@gmail.com",
                   "Purwokerto"
               )
